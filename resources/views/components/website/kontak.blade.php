<section class="pt-16 md:pt-28" id="kontak">
    <div class="w-full px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="mx-auto text-center">
            <h1 class="text-red-600 text-3xl md:text-5xl font-semibold">Kontak</h1>
                ...
                <div>
                    <div
                        ...
                        <span class="text-xl font-semibold">
                            <svg class="fill-current text-gray-700 w-6 h-6" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512">
                                <path
                ...
                <div>
                    <div
                        ...
                        <span class="text-xl font-semibold text-gray-700">
                            <svg class="fill-current text-gray-700 w-7 h-7" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512">
                                <path
